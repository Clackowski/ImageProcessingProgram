...
public class AsynchControllerImpl implements IAsynchController, IFeatures {
  ...
  protected IGUIView view;//change to protected
  protected final IModel model;//change to protected
  protected final Map<String, Supplier<IImageOperation>> imageOperationMap; //change to protected
